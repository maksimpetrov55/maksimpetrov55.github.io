$(document).ready(function() {
	...
	function calculation() {
		...
		var calc_form = $('input[name=calc_form]:checked').val();
		...
		var calc_plenka_itog = calc_plenka * 450;
		...
		var calc_itog = +calc_quantity * +calc_square * ( +calc_glass_value + +calc_obrabotka + +calc_zakalka ) + ( +calc_hole_amount * +calc_hole_price ) + (+calc_outer_amount * +calc_outer_price) + (+calc_inner_amount * +calc_inner_price) + +calc_plenka_itog + calc_facet_itog;
